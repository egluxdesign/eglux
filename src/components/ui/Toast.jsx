...
const Toast = ({ toast, onClose, duration = 4000 }) => {
  ...
  return (
    <div
      key={toast.id}
      className={`fixed bottom-8 left-8 z-[9999] flex items-center gap-3 px-4 py-3 rounded-xl border ${style.bg} ${style.border} ${style.text} shadow-lg max-w-sm transition-all duration-500 ${
